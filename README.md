...
<p align="center">
  <img src="assets/quickstart-demo.png" alt="Quick start demo: install, configure, run first prompt" width="80%" />
</p>
...
├── quickstart-demo.png          # 30-second GIF: install → config → first prompt
